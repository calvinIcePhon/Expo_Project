...
const AddProductPage: React.FC<AddProductPageProps> = (props) => {
  ...
  const addProduct = async (images: DataType[]) => {
    ...
    const customProductId = `product${(
      productTotalNum + 1
    ).toString()}_${day}_${month}_${year}_${sellerInfo?.sellerId}`;
  ...
  const FloatingChatBox = () => {
    ...
    return (
      <View style={styles.ChatBoxcontainer}>
        ...
        <TouchableOpacity style={styles.chatButton} onPress={toggleChatBox}>
...
const styles = StyleSheet.create({
  ...
  chatBox: {
    ...
    shadowRadius: 3.84,
    elevation: 5,
    maxHeight: 300, // Set a maximum height for the chat box
  },
  ...
  userMessageBubble: {
    backgroundColor: "#007AFF",
    alignSelf: "flex-end", // Align assistant messages to the right
  },
  messageText: {
    color: "black",
  },
